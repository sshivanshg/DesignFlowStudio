...
// Add a record to a Notion database
export async function addRecordToDatabase(databaseId: string, properties: any) {
    try {
        ...
        console.error("Error adding record to Notion database:", error);
        throw error;
    }
}

// Query records from a Notion database
export async function queryDatabaseRecords(databaseId: string, filter?: any, sorts?: any) {
    try {
...
// Update a record in a Notion database
export async function updateNotionRecord(pageId: string, properties: any) {
    try {
